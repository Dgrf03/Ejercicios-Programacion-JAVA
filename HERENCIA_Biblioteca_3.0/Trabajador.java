...
public class Trabajador extends Persona {
    ...
    // Muestra los libros prestados por este trabajador
    @Override
    public void consultarLibros(Biblioteca b) {
        System.out.println("\nLibros prestados por el trabajador " + getNombre() + ":");
        boolean hay = false;

        if (b.getPrestamo1() != null && this.equals(b.getPrestamo1().getT())) {
            System.out.println(b.getPrestamo1().getL());
            hay = true;
        }
        if (b.getPrestamo2() != null && this.equals(b.getPrestamo2().getT())) {
            System.out.println(b.getPrestamo2().getL());
            hay = true;
        }

        if (!hay) {
            System.out.println("No ha gestionado préstamos.");
        }
    }
}
